...
\newcommand{\myThesisKeywords}{Algoritmo, Postcuántico, IoT, ESP32, Dilithium} % (máximo de cinco)
\newcommand{\myThesisKeywordsEnglish}{Algorithm, Post-quantum, IoT, ESP32, Dilithium} % (up to a maximum of five)
